...
class wp_sherif_conversion_frontend_cookie{
	...
	static function make_action_to_set_cookie(){
		if(self::$current_post){			
			...
			self::set_cookie_for_different_pages();
		}
	}
	
	
	/*
	 * cookies for different pages
	 * */
	static function set_cookie_for_different_pages(){
		
		global $wpdb;
		$sql = "SELECT post_id FROM $wpdb->postmeta WHERE meta_key = 'cookie-excludes-checkbox' AND meta_value = 'Y'";									
